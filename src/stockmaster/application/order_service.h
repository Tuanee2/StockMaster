...
struct DraftOrderItemInput {
    ...
    QString preferredLotId;
};

struct StockAllocationInfo {
    QString orderId;
    QString orderItemId;
    QString lotId;
    int qty = 0;
...
public:
    ...
    [[nodiscard]] QVector<StockAllocationInfo> findAllocations(const QString &orderId,
...
private:
    ...
    [[nodiscard]] bool planDraftAllocationsForItem(const QString &orderId,
                                                   const QString &orderItemId,
                                                   const DraftOrderItemInput &input,
    ...
    QVector<StockAllocationInfo> m_stockAllocations;
